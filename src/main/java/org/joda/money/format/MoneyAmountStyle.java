...
public final class MoneyAmountStyle implements Serializable {
     ...
     */
    private static final Map<Locale, MoneyAmountStyle> LOCALIZED_CACHE = new HashMap<>();
    /**
...
//            size = size <= 0 ? 3 : size;
            protoStyle = new MoneyAmountStyle(
                    Integer.parseInt(numberConstants.zeroDigit()),
                    '+',
                    numberConstants.minusSign().charAt(0),
                    numberConstants.monetarySeparator().charAt(0),
                    GroupingStyle.FULL,
